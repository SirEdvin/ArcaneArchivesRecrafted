...
/** Native NeoForge counterparts of the Forge Reservoir fixtures; components replace legacy item NBT. */
...
public final class NeoForgeRuntimeTests {
    ...
    public static void matrixDistillateLifecycle(GameTestHelper helper) {
        MatrixDistillateLifecycle.run(helper, helper.makeMockPlayer(net.minecraft.world.level.GameType.SURVIVAL),
            (stack, tag) -> stack.set(net.minecraft.core.component.DataComponents.BLOCK_ENTITY_DATA,
    ...
    public static void matrixReservoirCrafting(GameTestHelper helper) {
        MatrixReservoirCrafting.run(helper, helper.makeMockPlayer(net.minecraft.world.level.GameType.SURVIVAL), helper.makeMockPlayer(net.minecraft.world.level.GameType.SURVIVAL));
    }
    ...
    public static void matrixReservoirPlacementCancellation(GameTestHelper helper) {
        ...
        stack.set(net.minecraft.core.component.DataComponents.CUSTOM_NAME,
            net.minecraft.network.chat.Component.literal("must survive cancellation"));
        ...
        java.util.function.Consumer<net.neoforged.neoforge.event.level.BlockEvent.EntityPlaceEvent> cancel = event -> {
            if (event.getEntity() == player) {
                captured.set(event instanceof net.neoforged.neoforge.event.level.BlockEvent.EntityMultiPlaceEvent multi
        ...
        try {
            var result = net.neoforged.neoforge.common.CommonHooks.onPlaceItemIntoWorld(context);
            ...
            if (level.captureBlockSnapshots || level.restoringBlockSnapshots || !level.capturedBlockSnapshots.isEmpty()) {
                helper.fail("Cancellation leaked NeoForge snapshot state"); return;
            }
            ...
            MatrixDistillateCancellation.run(helper, player, parent,
                net.neoforged.neoforge.common.CommonHooks::onPlaceItemIntoWorld, captured,
            ...
            DevicePlacementCancellation.run(helper, player, parent,
                net.neoforged.neoforge.common.CommonHooks::onPlaceItemIntoWorld, captured,
                () -> !level.captureBlockSnapshots && !level.restoringBlockSnapshots && level.capturedBlockSnapshots.isEmpty(),
                (carrier, tag) -> carrier.set(net.minecraft.core.component.DataComponents.BLOCK_ENTITY_DATA,
                    net.minecraft.world.item.component.CustomData.of(tag)));
        } finally {
